...
int main() {
    ...
    fecha dateLibro;
    dateLibro.dia = 15, date.mes = 3, date.anio = 2024;
    ...
    Estudiante* est = new Estudiante("Alex García", 52365899, "ag5678@gmail.com");
